...
set custom_hdl   [file join $project_root "rtl"]
set build_dir    [file join $project_root "build" "vivado"]
set output_bit   [file join $project_root "build" "frequency_to_voltage.bit"]
...
add_files [list [file join $custom_hdl sys_bus_cdc.sv]]
add_files [list \
...
route_design
source [file join $script_dir finish_build.tcl]
